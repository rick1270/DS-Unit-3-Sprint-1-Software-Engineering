...
I pay attention to output spelling and grammar.  Commands and input throw errors when they are not correct.  However, items in "" get printed out wrong if not caught.  This is what I check for first.  Also, I check for ways to streamline code.

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation? 

A container is a standard unit of software that packages up code and all its dependencies so the application runs quickly and reliably from one computing environment to another. This will ensure that everyone at Acme is working in the sam environment.  Additionally, results are standardized and reproduceable.  The phrase, "it worked fine on my computer" is no longer a valid excuse.  
